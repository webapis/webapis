  ...
  cy.window()
    ...
    .then((result) => {
      ...
      cy.request({
        ...
        cy.request({
          method: "GET",
          url: `https://localhost:1337/parse/classes/HangoutUser?where=${JSON.stringify(
            { userid: objectId }
          )}`,
          headers,
          form: true,
          ...
          cy.request({
            method: "DELETE",
            url: `https://localhost:1337/parse/classes/HangoutUser/${objectId}`,
            headers,
          });
        });
        ...
        cy.request({
          method: "GET",
          headers,
          url: `https://localhost:1337/parse/classes/Hangout?where= ${JSON.stringify(
            { userid: objectId }
          )}`,
          form: true,
        }).then((response) => {
          ...
          cy.request({
            method: "DELETE",
            url: `https://localhost:1337/parse/classes/Hangout/${objectId}`,
            headers,
          });
        });
      });
