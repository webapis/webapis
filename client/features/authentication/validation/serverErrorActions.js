...
export default function serverValidation({ status = 0, dispatch }) {
  ...
  switch (status) {
    ...
    case httpStatus.emailIsNotRegistered:
      dispatch({ type: actionTypes.CONSTRAINT_VALIDATION, name: 'emailorusername', isValid: false, message: validationMessages.EMAIL_NOT_REGISTERED })
      break;
    case 202:
    ...
    case httpStatus.emailorusernameNotValid:
      dispatch({ type: actionTypes.CONSTRAINT_VALIDATION, name: 'emailorusername', isValid: false, message: validationMessages.INVALID_USERNAME_OR_EMAIL })
      break;
    case httpStatus.usernameIsNotRegistered:
      dispatch({ type: actionTypes.CONSTRAINT_VALIDATION, name: 'emailorusername', isValid: false, message: validationMessages.USERNAME_NOT_REGISTERED })
      break;
