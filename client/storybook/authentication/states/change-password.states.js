...
const validationSuccess = { password: { isValid: true, message: '.' }, confirm: { isValid: true, message: '.' } }
const validationError = { password: { isValid: false, message: 'invalid password format' }, confirm: { isValid: false, message: 'invalid password format' } }
  ...
  return <div className="container">
    ...
    <div className="row" >
      <span className="col-md-12">
        ...
        <ChangePassword password="123456789" confirm="123456789" validation={validationSuccess} error={{ message: 'Server is unavailable' }} />
      </span>
    </div>
  </div>
}