...
const Login = L(() => import('./Login-c3a398a7.js'));
const ChangePassword = L(() => import('./ChangePassword-cbaa7e69.js'));
const ForgotPassword = L(() => import('./ForgotPassword-1019a1ca.js'));
const Signup = L(() => import('./Signup-ab5cc5e1.js'));
H(h(AppProvider, null, h(AuthProvider, null, h(RouteProvider, null, h(Link, {
  ...
  path: "/changepassword"
}, h(U, null), h(ChangePassword, null)), h(Route, {
  path: "/login"
