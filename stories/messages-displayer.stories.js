...
} from '../client/chat/messages-displayer';
...
export const dateLineBreak = () => {
  return <DateLinebreak datetime={1569393960355} />;
};
export const avatar = () => {
  return <Avatar letter='A' />;
};
...
export const messageView = () => {
  return <MessageView datetime={1569393960355} message='hello' />;
};
...
export const messageCollectionView = () => {
  return <MessageCollectionView messages={messages} />;
};

export const messageDisplayer = () => {
  return <MessagesDispaler messages={messages} />;
};
