...
async function changePassword({
  ...
  try {
    ...
    debugger;
    const response = await fetch(`${"https://10.100.36.114:3000"}/auth/changepass`, {
      method: 'put',
      body: JSON.stringify({
        confirm,
        password,
...
const PhoneDrawer = O(() => import('./PhoneDrawer-209debd9.js'));
const TabletDrawer = O(() => import('./TabletDrawer-bcbfe79a.js'));
const LaptopDrawer = O(() => import('./LapTopDrawer-bb4a953e.js'));
const DesktopDrawer = O(() => import('./DesktopDrawer-3a6cd591.js'));
...
const Login = O(() => import('./Login-5e9b1409.js'));
const ChangePassword = O(() => import('./ChangePassword-41fdb181.js'));
const ForgotPassword = O(() => import('./ForgotPassword-05255d4d.js'));
const Signup = O(() => import('./Signup-5a0d30dc.js'));
const Profile = O(() => import('./Profile-855afea8.js'));
const AuthFeedback = O(() => import('./AuthFeedback-6e2d0e39.js'));
...
const Hangouts = O(() => import('./index-b62aba27.js'));
const Group = O(() => import('./group-1110a0f6.js'));
function App() {
  return h("div", {
    style: {
      height: '100vh'
