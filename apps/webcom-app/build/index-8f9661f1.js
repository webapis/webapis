...
function updateMessage({
  ...
  const updatedMessages = messages.splice(hangoutIndex, 1, { ...message,
    delivered: true,
    username
  });
  localStorage.setItem(messageKey, JSON.stringify(updatedMessages));
...
function saveHangout(dispatch, hangout, name, focusedHangout, onAppRoute) {
  const {
    username
  } = hangout;
  const hangoutKey = `${name}-hangouts`;
...
const PhoneDrawer = L(() => import('./PhoneDrawer-b3543eb7.js'));
const TabletDrawer = L(() => import('./TabletDrawer-9b883b11.js'));
const LaptopDrawer = L(() => import('./LapTopDrawer-30cf35f8.js'));
const DesktopDrawer = L(() => import('./DesktopDrawer-c6d34163.js'));
...
const Login = L(() => import('./Login-95ad658d.js'));
const ChangePassword = L(() => import('./ChangePassword-df63d6d0.js'));
const ForgotPassword = L(() => import('./ForgotPassword-30675a75.js'));
const Signup = L(() => import('./Signup-9be4daed.js'));
const Profile = L(() => import('./Profile-7b624e92.js'));
const AuthFeedback = L(() => import('./AuthFeedback-e15ffcb9.js'));
...
const Hangouts = L(() => import('./index-cb5a1753.js'));
const Group = L(() => import('./group-a398133c.js'));
function App() {
