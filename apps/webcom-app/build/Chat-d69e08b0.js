import { h, m, l, _ as _extends } from './index-d17aa3cb.js';
...
const useMessageSorter = messages => {
  const [sortedMessages, setSortedMessages] = m(messages);
  l(() => {
...
const useMessagesMapper = messages => {
  const [mappedMessages, setMappedMessages] = m(messages);
