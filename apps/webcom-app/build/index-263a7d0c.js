...
const Login = L(() => import('./Login-ebece61e.js'));
const ChangePassword = L(() => import('./ChangePassword-5a74ae07.js'));
const ForgotPassword = L(() => import('./ForgotPassword-78b5d1f6.js'));
const Signup = L(() => import('./Signup-d9e94f6f.js'));
const Profile = L(() => import('./Profile-23daa7dc.js'));
const AuthFeedback = L(() => import('./AuthFeedback-9312e1c7.js'));
...
const Hangouts = L(() => import('./index-ac1972df.js'));
const Group = L(() => import('./group-9b1885bf.js'));
function AppRoutes() {
  return h("div", {
    style: {
      height: '100%'
