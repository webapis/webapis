...
function reducer$1(state, action) {
  switch (action.type) {
    ...
    case actionTypes$4.SOCKET_ERROR:
      return { ...state,
        error: action.error
      };

    case actionTypes$4.CONNECTING:
      return { ...state,
        readyState: 0
      };

    case actionTypes$4.OPEN:
      return { ...state,
        readyState: 1
      };

    case actionTypes$4.CLOSING:
      return { ...state,
        readyState: 2
      };

    case actionTypes$4.CLOSED:
      return { ...state,
        readyState: 3
      };

    case actionTypes$4.SOCKET_READY:
      return { ...state,
  ...
  l(() => {
    if (username) {
      ...
      sock.onmessage = message => {
        ...
        dispatch({
          type: actionTypes$4.SOCKET_MESSAGE_RECIEVED,
          message: msg
        });
        debugger;
      };
      ...
      sock.onopen = () => {
        debugger;
        dispatch({
          type: actionTypes$4.OPEN
        });
      };

      sock.onclose = () => {
        dispatch({
          type: actionTypes$4.CLOSED
        });
      };

      sock.onerror = error => {
        dispatch({
          type: actionTypes$4.SOCKET_ERROR,
          error
        });
      };

      dispatch({
        type: actionTypes$4.SOCKET_READY,
        socket: sock
      });
    }
  }, [username]);
...
function useHangouts() {
  ...
  const handleMessageRouter = useMessageRouter({
    dispatch,
    message,
    username
  });
...
const PhoneDrawer = O(() => import('./PhoneDrawer-2345b501.js'));
const TabletDrawer = O(() => import('./TabletDrawer-e49e9779.js'));
const LaptopDrawer = O(() => import('./LapTopDrawer-ff96b227.js'));
const DesktopDrawer = O(() => import('./DesktopDrawer-6446bed7.js'));
...
const Login = O(() => import('./Login-4c7ef276.js'));
const ChangePassword = O(() => import('./ChangePassword-0190e012.js'));
const ForgotPassword = O(() => import('./ForgotPassword-5b3923f2.js'));
const Signup = O(() => import('./Signup-d0dc6bf1.js'));
const Profile = O(() => import('./Profile-6b11334e.js'));
const AuthFeedback = O(() => import('./AuthFeedback-b3ed333c.js'));
...
const Hangouts = O(() => import('./index-03eaff07.js'));
const Group = O(() => import('./group-9b115e40.js'));
function App() {
