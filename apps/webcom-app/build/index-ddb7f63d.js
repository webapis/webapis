...
function MenuWhite({ onClick, device, id }) {
...
function AuthProvider(props) {
  ...
  return h(
    ...
    h(AuthRouteProvider, null, children)
  );
}
...
async function signup({ dispatch, formDispatch, state }) {
  dispatch({
...
async function forgotPassword({ dispatch, state, formDispatch }) {
  debugger;
...
function recoverLocalAuthState({ user, dispatch }) {
  dispatch({
...
const PhoneDrawer = L(() => import("./PhoneDrawer-75d87468.js"));
const TabletDrawer = L(() => import("./TabletDrawer-cdcda92c.js"));
const LaptopDrawer = L(() => import("./LapTopDrawer-b63a3c55.js"));
const DesktopDrawer = L(() => import("./DesktopDrawer-af354494.js"));
...
const Login = L(() => import("./Login-e1ee3c90.js"));
const ChangePassword = L(() => import("./ChangePassword-a411e8c9.js"));
const ForgotPassword = L(() => import("./ForgotPassword-628b5aea.js"));
const Signup = L(() => import("./Signup-c64739f0.js"));
const Profile = L(() => import("./Profile-dcbd1d5d.js"));
const AuthFeedback = L(() => import("./AuthFeedback-eaa29fc2.js"));
...
function DrawerContent({ authContent, otherContent }) {
  return h(
    "div",
    null,
    h("div", null, authContent),
    h("div", null, otherContent)
  );
}
...
function ListItem({ children, onClick, id }) {
  return h(
    "div",
    {
      id: id,
...
function AuthedState({ handleRoute, userName, setRootRoute }) {
...
function UnAuthedState({ handleRoute }) {
  return h(
    "div",
    null,
    h(
...
function AppProvider(props) {
  const { title, accept_inv_img = img$1 } = props;
  return h(
    AppContext.Provider,
    _extends(
      {
...
const Hangouts = L(() =>
  import("./index-ba91dcf6.js").then(function (n) {
    return n.i;
  })
);
const Group = L(() => import("./group-398e5777.js"));
H(
  h(
    AppProvider,
    {
...
export {
  ...
  _extends as _,
  useMediaQuery as a,
  useRouteContext as b,
  useRootRouteContext as c,
  useAuthRouteContext as d,
  useFormContext as e,
  validationTypes as f,
  valueChanged as g,
  h,
  validationStates as i,
  isClientValidationType as j,
  clientValidation as k,
  login as l,
  m$1 as m,
  styleInject as n,
  useThemeContext as o,
  p$1 as p,
  useUserName as q,
  resetInputValidationState as r,
  s$1 as s,
  getTokenFromUrl as t,
  useAuthContext as u,
  v$1 as v,
  changePassword as w,
  forgotPassword as x,
