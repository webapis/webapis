...
function reducer$1(state, action) {
  switch (action.type) {
    ...
    case actionTypes$3.SAVED_MESSAGE_LOCALLY:
      if (state.messages) {
        return { ...state,
    ...
    case actionTypes$3.FETCH_USER_STARTED:
      return { ...state,
        loading: true
      };

    case actionTypes$3.FETCH_USER_SUCCESS:
      return { ...state,
        loading: false,
        users: action.users
      };
    ...
    case actionTypes$3.HANGOUT_NOT_FOUND:
      return { ...state,
        loading: false
      };
    ...
    case actionTypes$3.SELECTED_USER:
      if (state.hangouts) {
        return { ...state,
    ...
    case actionTypes$3.HANGOUT_RECIEVED:
      return { ...state,
        hangout: action.hangout,
...
function saveMessage({
  ...
  dispatch({
    type: actionTypes$3.SAVED_MESSAGE_LOCALLY,
    message
  });
}
  ...
  l(() => {
    if (socketMessage && focusedHangout && username) {
      ...
      if (socketMessage.type === 'ACKHOWLEDGEMENT') {
        ...
        dispatch({
          type: actionTypes$3.ACKHOWLEDGEMENT_RECIEVED,
          hangout,
          username
        });
        handleRoute({
        ...
        if (hangout.username === focusedHangout.username) {
          dispatch({
            type: actionTypes$3.FOCUSED_HANGOUT_RECIEVED,
            hangout,
            username
          });
        } else {
          ...
          dispatch({
            type: actionTypes$3.UNFOCUSED_HANGOUT_RECIEVED,
            hangout,
            username
          });
        }
        ...
        dispatch({
          type: actionTypes$3.OFFLINE_HANGOUTS_RECIEVED,
          hangouts,
          username
        });
      }
...
const PhoneDrawer = O(() => import('./PhoneDrawer-e8bd210c.js'));
const TabletDrawer = O(() => import('./TabletDrawer-b607636d.js'));
const LaptopDrawer = O(() => import('./LapTopDrawer-7bd1b008.js'));
const DesktopDrawer = O(() => import('./DesktopDrawer-592c1619.js'));
...
const Login = O(() => import('./Login-3a0033ad.js'));
const ChangePassword = O(() => import('./ChangePassword-8482a018.js'));
const ForgotPassword = O(() => import('./ForgotPassword-509328b6.js'));
const Signup = O(() => import('./Signup-75f467a2.js'));
const Profile = O(() => import('./Profile-621e16f2.js'));
const AuthFeedback = O(() => import('./AuthFeedback-9a874f87.js'));
...
const Hangouts = O(() => import('./index-010d9f94.js'));
const Group = O(() => import('./group-c23d0c25.js'));
function App() {
